...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { author: @clip.author, description: @clip.description, file_name: @clip.file_name, format: @clip.format, name: @clip.name }
    end
  ...
  test "should update clip" do
    patch :update, id: @clip, clip: { author: @clip.author, description: @clip.description, file_name: @clip.file_name, format: @clip.format, name: @clip.name }
    assert_redirected_to clip_path(assigns(:clip))
  end
